...
namespace WhoYouAre {
	...
	public class InteractionWorker_DeepTalk_Backstory : InteractionWorker_DeepTalk {
		...
		public override void Interacted(Pawn initiator, Pawn recipient, List<RulePackDef> extraSentencePacks, out string letterText, out string letterLabel, out LetterDef letterDef, out LookTargets lookTargets) {
			...
			InteractionWorkerUtil.EvaluateBackstory(initiator, recipient, out letterText, out letterLabel, out letterDef, out lookTargets);
